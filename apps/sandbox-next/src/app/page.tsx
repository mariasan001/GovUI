...
export const ITEMS: Item[] = [
  ...
  { key: 'alerts',    slug: 'alertas',     title: 'Alertas',             variations: 10,     keywords:['notificaciones','estado'] },
  { key: 'buttons',   slug: 'botones',     title: 'Botones',             variations: 8,     keywords:['cta','acciones'] },
  { key: 'layout',    slug: 'layout',      title: 'Layout',              variations: 1,     keywords:['grid','stack','container'] },
  { key: 'forms',     slug: 'formularios', title: 'Formularios',         variations: 11,     keywords:['inputs','select','checkbox'] },
  { key: 'search',    slug: 'buscador',    title: 'Buscador',            variations: 10,     keywords:['search','filtros'] },
  { key: 'charts',    slug: 'graficas',    title: 'Gráficas',            variations: 24,     keywords:['charts','sparkline'] },
  { key: 'calendars', slug: 'calendarios', title: 'Calendarios',         variations: 10,     keywords:['date','calendar'] },
